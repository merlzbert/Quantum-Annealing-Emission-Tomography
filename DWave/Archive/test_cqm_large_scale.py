...
from tomography_cqm import get_cqm_integer, sample_cqm, get_cqm_reconstructions, save_sampleset, get_cqm_integer_separatevars
import numpy as np
import dimod
import os
...
for m in mat_sizes:
    ...
    for f in filenames:
        ...
        # Set up problem
        print("Sers")
        bqm = get_cqm_integer_separatevars(system, sinogram, lowerBound=0, upperBound=4)
